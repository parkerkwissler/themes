...
class Educator_Theme_Customize {
	...
	public static function init() {
		...
		add_action( 'wp_head', array( __CLASS__, 'output_style' ) );
	}
	...
	public static function general_settings( $wp_customize ) {
		...
		// Enable/disable theme update notifications.
		$wp_customize->add_setting(
			'updates_notifier',
			array(
				'default'           => '1',
		...
		$wp_customize->add_control(
			'educator_updates_notifier',
			array(
				'label'       => __( 'Theme Updates Notifications', 'ib-educator' ),
				'section'     => 'educator_general',
				'settings'    => 'updates_notifier',
				'type'        => 'checkbox',
				'description' => __( 'The theme will check incrediblebytes.com for updates. If there is an update available, it will display an admin notice.', 'ib-educator' ),
				'priority' => 3,
			)
		);
	}
